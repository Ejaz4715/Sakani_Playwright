...
import {FlexiblePaymentObjects} from '@objects/Developer/FlexiblePaymentObjects';
import { BookingAndSelectPaymentMethodObjects } from "@objects/User/BookingAndSelectPaymentMethodObjects";
const path = require("path");

// const { FlexiblePaymentObjects } = require(

//     path.join(process.cwd(), "src", "Objects", "Developer", "FlexiblePaymentObjects"),
// );
