...
test("TC-03 - verify non-saudi user can not book offplan unit", async ({ page }) => {
  test.setTimeout(0);
 ...
 const page1Promise = page.waitForEvent("popup");
...

  {
    ...
    await bookingApp.createMegaProjectPage.verifyProjectNotAvailableForNonSaudiMessage();
  }
});
